...
matrix describes a linear map (in a given basis, meaning, basis needed to be provided, often implicitly
assumed to be canonical although it can be any basis).
