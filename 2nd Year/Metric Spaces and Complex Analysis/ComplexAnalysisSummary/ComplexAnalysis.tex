...
\begin{remark}
    ...
    Armed with residue theorem and deformation theorem,
    you can compute a vast amount of integrals really easily!
\end{remark}
\begin{remark}
...
\begin{remark}
    ...
    Whenever you see an integral involving trig function such as $\sin z$ or $\cos z$, you know that you can write it as some combination of $z, \bar z$, but it is convenient to take the curve to be unit circle so that $\bar z = \frac{1}{z}$, so that we don't have to worry about the conjugate symbol.
\end{remark}
