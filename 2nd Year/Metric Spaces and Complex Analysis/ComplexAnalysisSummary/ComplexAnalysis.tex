...
\begin{definition}[Homotopy and Simply-Connectedness]
    ...
    \begin{figure}[tbp]
        ...
        \begin{subfigure}[b]{0.5\textwidth}
            ...
            \caption{These two curves are homotopic in $\C$ as you can continuous deform one to get the other.}
        \end{subfigure}
        \hfill
        \centering
        \begin{subfigure}[b]{0.5\textwidth}
            ...
            \caption{These two curves are not homotopic in the annulus as you cannot continuous deform one to get the other.}
        \end{subfigure}
